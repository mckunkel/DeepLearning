...
public class YourFirstSparkProgram {
	...
	public static void main(String[] args) {
		...
		String sparkMaster = "spark://134.94.180.35:7077";
		...
		/*
		 * //Convert to upper case JavaRDD<String> ucRDD = tweetsRDD.map( str ->
		 * str.toUpperCase()); //Print upper case lines for ( String s :
		 * ucRDD.take(5)) { System.out.println(s); }
		 */
 ...
 * 
 * spark-class org.apache.spark.deploy.master.Master Use the IP and Port
 * provided.
 * 
